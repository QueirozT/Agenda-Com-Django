...
TEMPLATES = [
    {
        ...
        'DIRS': [Path.joinpath(BASE_DIR, 'templates')], # Registrando os templates
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
...
# Messages
# https://docs.djangoproject.com/en/4.1/ref/settings/#messages-debug
...
# Configurando o sistema de storage da aws no django
